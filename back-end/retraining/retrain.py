...
CHECKPOINT_NAME = os.path.split(
    os.getcwd())[0] + '/back-end/tmp/_retrain_checkpoint'
...
def create_model_info(architecture):
 ...
 but found '%s' for architecture '%s'""",
        ...
        tf.logging.error(
            "Couldn't understand architecture name '%s'",
            architecture)
...
#       '--output_graph',
#       type=str,
#       default=os.path.split(os.getcwd())[0]+'/back-end/tmp/output_graph.pb',
#       help='Where to save the trained graph.'
#   )
#   parser.add_argument(
#       '--intermediate_output_graphs_dir',
#       type=str,
#       default=os.path.split(os.getcwd())[0]+'/back-end/tmp/intermediate_graph/',
...
#       '--output_labels',
#       type=str,
#       default=os.path.split(os.getcwd())[0]+'/back-end/tmp/output_labels.txt',
#       help='Where to save the trained graph\'s labels.'
#   )
#   parser.add_argument(
#       '--summaries_dir',
#       type=str,
#       default=os.path.split(os.getcwd())[0]+'/back-end/tmp/retrain_logs',
...
#       '--model_dir',
#       type=str,
#       default=os.path.split(os.getcwd())[0]+'/back-end/tmp/imagenet',
#       help="""\
...
#       '--bottleneck_dir',
#       type=str,
#       default=os.path.split(os.getcwd())[0]+'/back-end/tmp/bottleneck',
...
#       '--saved_model_dir',
#       type=str,
#       default=os.path.split(os.getcwd())[0]+'/back-end/tmp/saved_models/2/',
...
FLAGS = Namespace(
    ...
    bottleneck_dir=os.path.split(
        os.getcwd())[0] +
    '/back-end/tmp/bottleneck',
    eval_step_interval=10,
    final_tensor_name='final_result',
    flip_left_right=False,
    how_many_training_steps=4000,
    image_dir='dataset',
    intermediate_output_graphs_dir=os.path.split(
            os.getcwd())[0] +
    '/back-end/tmp/intermediate_graph/',
    intermediate_store_frequency=0,
    learning_rate=0.01,
    model_dir='inceptionV3',
    output_graph=os.path.split(
                os.getcwd())[0] +
    '/back-end/tmp/output_graph.pb',
    output_labels=os.path.split(
                    os.getcwd())[0] +
    '/back-end/tmp/output_labels.txt',
    print_misclassified_test_images=False,
    random_brightness=0,
    random_crop=0,
    random_scale=0,
    saved_model_dir=os.path.split(
                        os.getcwd())[0] +
    '/back-end/tmp/saved_models/2/',
    summaries_dir=os.path.split(
                            os.getcwd())[0] +
    '/back-end/tmp/retrain_logs',
    test_batch_size=-
    1,
